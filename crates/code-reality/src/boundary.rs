...
pub fn run_query(sc: &LoadedSidecar, symbol: &str, rs_mode: bool) -> ToolOutput {
...
pub fn run(argv: &[&str]) -> ToolOutput {
    ...
    let spec = crate::argparse::ToolSpec {
        flags: &[
            crate::argparse::FlagSpec {
                long: "--repo",
                short: None,
                kind: crate::argparse::Kind::Value { metavar: "REPO" },
            },
            crate::argparse::FlagSpec {
                long: "--rs",
                short: None,
                kind: crate::argparse::Kind::StoreTrue,
            },
            crate::argparse::FlagSpec {
                long: "--sidecar-dir",
                short: None,
                kind: crate::argparse::Kind::Value {
                    metavar: "SIDECAR_DIR",
                },
            },
        ],
