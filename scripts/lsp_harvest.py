...
def slot_dir(repo: str) -> str:
    """In-repo slot (data-plane unification) + self-contained ignore."""
    data_root = os.path.join(repo, ".code-reality")
    gi = os.path.join(data_root, ".gitignore")
    if not os.path.exists(gi):
        os.makedirs(data_root, exist_ok=True)
        with open(gi, "w", encoding="utf-8") as f:
            f.write("# Auto-generated by code-reality — derived data, do not commit.\n*\n")
    return os.path.join(data_root, "scip")
